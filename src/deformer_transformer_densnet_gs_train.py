...
from models.backbone_densnet import *
...
def log_stats_train(train_results, epoch):
	tag_value = {'train_densnet_0520_gs_loss': train_results['train_loss'],
	             'train_densnet_0520_gs_accuracy': train_results['train_accuracy']}
	for tag, value in tag_value.items():
		writer.add_scalar(tag, value, epoch)


def log_stats_val(val_results, epoch):
	tag_value = {'validation_densnet_0520_gs_loss': val_results['val_loss'],
	             'validation_densnet_0520_gs_accuracy': val_results['val_accuracy']}
	for tag, value in tag_value.items():
		writer.add_scalar(tag, value, epoch)
...
if __name__ == "__main__":
	...
	res_dir = os.path.join(BASE_DIR, "results_densnet_gs_2022_0520_0947AM")
